...
<div class="remarkable-gallery">
  <a class="gallery-item" href="../assets/greenai-ecml-2026/Picture1.png" title="GREEN-AI Workshop, ECML-PKDD 2026">
    <img src="../assets/greenai-ecml-2026/Picture1.png" alt="Shaina Raza keynote at the GREEN-AI Workshop, ECML-PKDD 2026">
  </a>
  <a class="gallery-item" href="../assets/greenai-ecml-2026/Picture2.png" title="GREEN-AI Workshop, ECML-PKDD 2026">
    <img src="../assets/greenai-ecml-2026/Picture2.png" alt="DIA presentation at the GREEN-AI Workshop, ECML-PKDD 2026">
  </a>
</div>

- :material-file-document: **Harness-Aware Evaluation of LLM Agents**. Survey of how memory, tools, and execution software around an LLM change reported agent scores. [Project page](https://vectorinstitute.github.io/harness-aware-evaluation/) · [Preprint](https://www.preprints.org/manuscript/202609.2140) · [Code](https://github.com/VectorInstitute/harness-aware-evaluation).

- :material-book-open-variant: **Unified evaluation framework**. Framework for trustworthy evaluation across LLMs, agentic AI, and multimodal systems, with shared scoring bands and links to the EU AI Act, ISO, and NIST AI RMF. [Preprint](https://arxiv.org/abs/2609.19524).

- :material-check-decagram: **Stress-Testing Efficient Responsible-AI Evaluation accepted at NeurIPS 2026 TAE**. Study of how batching, quantization, and smaller subsets change bias-benchmark conclusions and energy use on BBQ and BBQ-V. [Project page](https://vectorinstitute.github.io/sustainable-rai-evaluation/) · [Preprint](https://arxiv.org/abs/2608.31108) · [Code](https://github.com/VectorInstitute/sustainable-rai-evaluation).

- :material-chart-bar: **FairLens**. Fairness benchmark for VLMs on high-stakes hiring, legal, and healthcare decisions from a face photograph, measuring parity, soundness, and refusal to judge from appearance. [Project page](https://vectorinstitute.github.io/fairlens/) · [Preprint](https://arxiv.org/abs/2609.01691) · [Code](https://github.com/VectorInstitute/fairlens) · [Dataset](https://huggingface.co/datasets/vector-institute/fairlens).

- :material-file-document: **Deepfakes in the Foundation-Model Era**. Survey of forensics, generation, and platform distribution. Detectors built for older deepfakes often miss newer ones circulating online. [Project page](https://vectorinstitute.github.io/deepfakes-survey-2026/) · [Preprint](https://www.preprints.org/manuscript/202608.1870) · [Code](https://github.com/VectorInstitute/deepfakes-survey-2026).
